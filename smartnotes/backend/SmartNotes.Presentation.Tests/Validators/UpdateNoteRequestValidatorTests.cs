...
public class UpdateNoteRequestValidatorTests
{
    private readonly UpdateNoteRequestValidator _validator;

    public UpdateNoteRequestValidatorTests()
    {
        _validator = new UpdateNoteRequestValidator();
    }
